...
def generate_test_description():
    ...
    test_param = load_yaml("moveit_kinematics", "config/fanuc-trac-ik-test.yaml")
    ...
    return (
        ...
        {"fanuc_trac_ik": fanuc_trac_ik},
    )


class TestTerminatingProcessStops(unittest.TestCase):
    def test_gtest_run_complete(self, proc_info, fanuc_trac_ik):
        proc_info.assertWaitForShutdown(process=fanuc_trac_ik, timeout=4000.0)
